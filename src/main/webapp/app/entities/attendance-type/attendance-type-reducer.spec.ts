...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTENDANCETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ATTENDANCETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ATTENDANCETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ATTENDANCETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ATTENDANCETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ATTENDANCETYPE actions', async () => {
      const expectedActions = [
        {

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="attendanceApp.attendanceType.home.createOrEditLabel" data-cy="AttendanceTypeCreateUpdateHeading">
            <Translate contentKey="attendanceApp.attendanceType.home.createOrEditLabel">Create or edit a AttendanceType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('attendanceApp.attendanceType.code')}
              ...
              />
              <ValidatedField
                label={translate('attendanceApp.attendanceType.descEn')}
              ...
              />
              <ValidatedField
                label={translate('attendanceApp.attendanceType.descAr')}

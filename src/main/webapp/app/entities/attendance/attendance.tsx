  ...
  return (
    <div>
      <h2 id="attendance-heading" data-cy="AttendanceHeading">
        <Translate contentKey="attendanceApp.attendance.home.title">Attendances</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="attendanceApp.attendance.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/attendance/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="attendanceApp.attendance.home.createLabel">Create new Attendance</Translate>
          </Link>
        </div>
      </h2>
        ...
        {attendanceList && attendanceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="attendanceApp.attendance.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('logDate')}>
                  <Translate contentKey="attendanceApp.attendance.logDate">Log Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('logTimeFrom')}>
                  <Translate contentKey="attendanceApp.attendance.logTimeFrom">Log Time From</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('logTimeTo')}>
                  <Translate contentKey="attendanceApp.attendance.logTimeTo">Log Time To</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('details')}>
                  <Translate contentKey="attendanceApp.attendance.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="attendanceApp.attendance.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="attendanceApp.attendance.hrApprovedBy">Hr Approved By</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {attendanceList.map((attendance, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{attendance.logDate ? <TextFormat type="date" value={attendance.logDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="attendanceApp.attendance.home.notFound">No Attendances found</Translate>
            </div>
          )
        )}
      </div>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="attendanceApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="attendanceApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('attendanceApp.department.code')}
                id="department-code"
                name="code"
                data-cy="code"
                type="text"
              />
              <ValidatedField
                label={translate('attendanceApp.department.nameEn')}
                id="department-nameEn"
                name="nameEn"
                data-cy="nameEn"
                type="text"
              />
              <ValidatedField
                label={translate('attendanceApp.department.nameAr')}
                id="department-nameAr"
                name="nameAr"
                data-cy="nameAr"
                type="text"
              />

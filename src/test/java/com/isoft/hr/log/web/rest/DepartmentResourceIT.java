...
import com.isoft.hr.log.repository.DepartmentRepository;
import com.isoft.hr.log.service.dto.DepartmentDTO;
import com.isoft.hr.log.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().code(DEFAULT_CODE).nameEn(DEFAULT_NAME_EN).nameAr(DEFAULT_NAME_AR);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().code(UPDATED_CODE).nameEn(UPDATED_NAME_EN).nameAr(UPDATED_NAME_AR);
        return department;
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.code(UPDATED_CODE).nameEn(UPDATED_NAME_EN).nameAr(UPDATED_NAME_AR);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.nameEn(UPDATED_NAME_EN);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.code(UPDATED_CODE).nameEn(UPDATED_NAME_EN).nameAr(UPDATED_NAME_AR);
